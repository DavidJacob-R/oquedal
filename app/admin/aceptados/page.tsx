...
export default function AdminAceptadosPage() {
  ...
  async function setEstado(id: string, estado: "cancelado" | "pendiente") {
    setSavingId(id);
    setErr(null);
    try {
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      <div className="flex flex-wrap gap-2 items-center mb-4">
        <div className="flex gap-2">
          ...
          <a href="/admin/aceptados" className="px-3 py-1.5 rounded-lg text-sm border border-violet-500/70 bg-zinc-900 text-zinc-100">Aceptados</a>
      ...
      <h1 className="text-2xl font-semibold text-zinc-100 mb-3">Pedidos aceptados</h1>
                    ...
                    <td className="px-3 py-2">
                      <div className="flex gap-2">
                        ...
                        <button
                          type="button"
                          disabled={disabled}
                          onClick={() => setEstado(r.id, "cancelado")}
