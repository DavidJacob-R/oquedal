...
import ClientesBoard from "@/components/admin/clientes/ClientesBoard";
    ...
    <div className="mx-auto max-w-7xl px-3 md:px-4 lg:px-6">
      <div className="sticky top-[64px] z-10 -mx-3 mb-5 bg-[#0b0b10]/70 px-3 py-3 backdrop-blur md:-mx-4 md:px-4 lg:-mx-6 lg:px-6 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold tracking-wide">Clientes</h1>
            <p className="text-xs text-neutral-400">Vista minimalista: búsqueda, edición inline y activación/desactivación rápida.</p>
          </div>
        </div>
      </div>
